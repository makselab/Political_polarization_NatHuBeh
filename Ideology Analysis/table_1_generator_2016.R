...
library(data.table)
library(dplyr)
##### PREPARE 2016 DATA FOR PLOT HIST AND TABLE ######
...
table_data$bias=factor(table_data$bias, 
                       levels = c("fake","far_right","right","lean_right",
                                  "center",
                                  "lean_left","left","far_left"),
...
save(table_data_for_plot_2016, file="Desktop/phd/uselection2020/us_pnas_2020/table_data_unique_users_2016.Rdata")
